    ...
    let expPerDay = expPerHour * day;
        switch (time) {
            case 'minute':
                ...
                break;
            case 'hour':
                console.log(Math.round(expPerHour));
                break;
            case 'day':
...
nonSkillCalc.woodcutting.woodTimeCalc('yew',false,'dragon',false,false);
nonSkillCalc.woodcutting.logsPerTimeCalc();
console.log(finalLogs,possibleLogs);
//expPerTime(finalLogTime,baseLogExp,'minute');S